...
from snotel.lib.types import ForecastDataDTO, StationDataDTO
...
class ForecastResultCollection:
    ...
    def _fetch_metadata_for_elements(
        ...
        return [ForecastDataDTO.model_validate(res) for res in result]
